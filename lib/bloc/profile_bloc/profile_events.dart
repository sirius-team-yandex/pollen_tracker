...
abstract class ProfileEvent with _$ProfileEvent {
  ...
  const factory ProfileEvent.endRegistration(ProfileEntity profile) = EndRegistration;
  const factory ProfileEvent.logOut() = LogOut;
  //additional
  const factory ProfileEvent.changeProfile(ProfileEntity newProfile) = ChangeProfile;
