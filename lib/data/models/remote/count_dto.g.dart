...
_$CountDtoImpl _$$CountDtoImplFromJson(Map<String, dynamic> json) => _$CountDtoImpl(
      grassPollen: json['grass_pollen'] as int?,
      treePollen: json['tree_pollen'] as int?,
      weedPollen: json['weed_pollen'] as int?,
    );

Map<String, dynamic> _$$CountDtoImplToJson(_$CountDtoImpl instance) => <String, dynamic>{
