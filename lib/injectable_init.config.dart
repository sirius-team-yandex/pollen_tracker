...
import 'bloc/profile_bloc/profile_bloc.dart' as _i31;
...
import 'data/datasources/pollen_local_storage_datasource_isar_impl.dart' as _i16;
import 'data/datasources/profile_local_storage_datasource_isar_impl.dart' as _i19;
...
import 'data/mappers/profile/profile_entity_to_profile_model_mapper.dart' as _i18;
import 'data/mappers/profile/profile_model_to_profile_entity_mapper.dart' as _i28;
...
import 'data/repositories/pollen_repository_impl.dart' as _i26;
import 'data/repositories/pollen_repository_mock_impl.dart' as _i27;
...
import 'domain/repositories/pollen_repository.dart' as _i25;
import 'domain/repositories/profile_repository.dart' as _i29;
import 'domain/usecases/risc_evaluator_usecase.dart' as _i20;
import 'injectable_init.dart' as _i32;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.PollenEntityToPollenModelMapper>(() => _i15.PollenEntityToPollenModelMapper());
    gh.factory<_i16.PollenLocalStorageDatasourceIsarImpl>(() => _i16.PollenLocalStorageDatasourceIsarImpl());
    gh.factory<_i17.PollenModelToPollenEntityMapper>(() => _i17.PollenModelToPollenEntityMapper());
    gh.factory<_i18.ProfileEntityToModelIsarMapper>(() => _i18.ProfileEntityToModelIsarMapper());
    gh.factory<_i19.ProfileLocalStorageDatasourceIsar>(() => _i19.ProfileLocalStorageDatasourceIsar());
    ...
    gh.factory<_i22.CitiesRepository>(
        () => _i23.CityRepositoryImpl(listDynamicToCityEntityMapper: gh<_i9.ListDynamicToCityEntityMapper>()));
    gh.factory<_i24.PollenDtoToPollenEntityMappper>(
        () => _i24.PollenDtoToPollenEntityMappper(stringSpeciesMapper: gh<_i21.StringSpeciesMapper>()));
    gh.factory<_i25.PollenRepository>(
      () => _i26.PollenRepositoryImpl(
        dio: gh<_i8.Dio>(),
    ...
    gh.factory<_i25.PollenRepository>(
      () => _i27.PollenRepositoryMock(mapper: gh<_i24.PollenDtoToPollenEntityMappper>()),
      registerFor: {_dev},
    );
    gh.factory<_i28.ProfileModelIsarToEntityMapper>(
        () => _i28.ProfileModelIsarToEntityMapper(stringSpeciesMapper: gh<_i21.StringSpeciesMapper>()));
    gh.factory<_i29.ProfileRepository>(() => _i30.ProfileRepositoryIsarImpl(
          gh<_i19.ProfileLocalStorageDatasourceIsar>(),
          gh<_i28.ProfileModelIsarToEntityMapper>(),
          gh<_i18.ProfileEntityToModelIsarMapper>(),
        ));
    gh.factory<_i31.ProfileBloc>(() => _i31.ProfileBloc(
          profileRepository: gh<_i29.ProfileRepository>(),
...
class _$Module extends _i32.Module {}
