...
import 'bloc/current_mood_bloc/current_mood_bloc.dart' as _i40;
import 'bloc/current_pollen_bloc/current_pollen_bloc.dart' as _i41;
import 'bloc/profile_bloc/profile_bloc.dart' as _i37;
import 'bloc/profiles_all_bloc/profiles_all_bloc.dart' as _i32;
import 'data/datasources/config_local_storage_datasource_isar_impl.dart' as _i20;
...
import 'data/datasources/profile_local_storage_datasource_isar_impl.dart' as _i15;
...
import 'data/mappers/profile/profile_entity_to_profile_model_mapper.dart' as _i14;
...
import 'data/repositories/mood_record_repository_impl.dart' as _i33;
import 'data/repositories/network_pollen_repository_impl.dart' as _i28;
import 'data/repositories/network_pollen_repository_mock.dart' as _i27;
...
import 'domain/repositories/mood_record_repository.dart' as _i38;
import 'domain/repositories/mood_record_subject.dart' as _i34;
import 'domain/repositories/network_pollen_repository.dart' as _i26;
import 'domain/repositories/pollen_repository.dart' as _i39;
import 'domain/repositories/pollen_subject.dart' as _i36;
...
import 'injectable_init.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i11.PollenEntityToPollenModelMapper>(() => _i11.PollenEntityToPollenModelMapper());
    gh.singleton<_i12.PollenLocalStorageDatasource>(() => _i12.PollenLocalStorageDatasource(isar: gh<_i6.Isar>()));
    gh.factory<_i13.PollenModelToPollenEntityMapper>(() => _i13.PollenModelToPollenEntityMapper());
    gh.factory<_i14.ProfileEntityToModelIsarMapper>(() => _i14.ProfileEntityToModelIsarMapper());
    ...
    gh.factory<_i18.CitiesRepository>(
        () => _i19.CityRepositoryImpl(listDynamicToCityEntityMapper: gh<_i7.ListDynamicToCityEntityMapper>()));
    gh.singleton<_i20.ConfigLocalStorageDatasourceIsar>(
        () => _i20.ConfigLocalStorageDatasourceIsar(isar: gh<_i6.Isar>()));
    gh.factory<_i21.ConfigRepositoryIsarImpl>(() => _i21.ConfigRepositoryIsarImpl(
          gh<_i20.ConfigLocalStorageDatasourceIsar>(),
          gh<_i4.ConfigModelIsarToEntityMapper>(),
          gh<_i3.ConfigEntityToModelIsarMapper>(),
        ));
    gh.factory<_i22.ConfigSubject>(() => configModule.configSubject(gh<_i21.ConfigRepositoryIsarImpl>()));
    gh.factory<_i23.PollenDtoToPollenEntityMappper>(
        () => _i23.PollenDtoToPollenEntityMappper(stringSpeciesMapper: gh<_i17.StringSpeciesMapper>()));
    gh.factory<_i24.ProfileModelIsarToEntityMapper>(
        () => _i24.ProfileModelIsarToEntityMapper(stringSpeciesMapper: gh<_i17.StringSpeciesMapper>()));
    gh.factory<_i25.ConfigRepository>(() => configModule.configRepository(gh<_i21.ConfigRepositoryIsarImpl>()));
    gh.factory<_i26.NetworkPollenRepository>(
      () => _i27.NetworkPollenRepositoryMock(mapper: gh<_i23.PollenDtoToPollenEntityMappper>()),
      registerFor: {
        _dev,
        _test,
      },
    ...
    gh.factory<_i26.NetworkPollenRepository>(
      () => _i28.NetworkPollenRepositoryImpl(
        dio: gh<_i5.Dio>(),
        pollenDtoToPollenEntityMapper: gh<_i23.PollenDtoToPollenEntityMappper>(),
      ),
      registerFor: {_prod},
    );
    gh.factory<_i29.ProfileRepositoryIsarImpl>(() => _i29.ProfileRepositoryIsarImpl(
          ...
          profileModelIsarToEntityMapper: gh<_i24.ProfileModelIsarToEntityMapper>(),
          profileEntityToModelIsarMapper: gh<_i14.ProfileEntityToModelIsarMapper>(),
        ));
    gh.factory<_i30.ProfileSubject>(() => profileModule.profileSubject(gh<_i29.ProfileRepositoryIsarImpl>()));
    gh.factory<_i31.ProfileRepository>(() => profileModule.profileRepository(gh<_i29.ProfileRepositoryIsarImpl>()));
    gh.factory<_i32.ProfilesAllBloc>(() => _i32.ProfilesAllBloc(
          profileRepository: gh<_i31.ProfileRepository>(),
          configRepository: gh<_i25.ConfigRepository>(),
          profileSubject: gh<_i30.ProfileSubject>(),
        ));
    gh.factory<_i33.MoodRecordRepositoryIsarImpl>(() => _i33.MoodRecordRepositoryIsarImpl(
    ...
    gh.factory<_i34.MoodRecordSubject>(() => moodModule.moodSubject(gh<_i33.MoodRecordRepositoryIsarImpl>()));
    gh.factory<_i35.PollenRepositoryImpl>(() => _i35.PollenRepositoryImpl(
          ...
          pollenModelToPollenEntityMapper: gh<_i13.PollenModelToPollenEntityMapper>(),
          pollenEntityToPollenModelMapper: gh<_i11.PollenEntityToPollenModelMapper>(),
        ));
    gh.factory<_i36.PollenSubject>(() => pollenModule.pollenSubject(gh<_i35.PollenRepositoryImpl>()));
    gh.factory<_i37.ProfileBloc>(() => _i37.ProfileBloc(
          profileSubject: gh<_i30.ProfileSubject>(),
          profileRepository: gh<_i31.ProfileRepository>(),
          configRepository: gh<_i25.ConfigRepository>(),
        ));
    gh.factory<_i38.MoodRecordRepository>(() => moodModule.moodRepository(gh<_i33.MoodRecordRepositoryIsarImpl>()));
    gh.factory<_i39.PollenRepository>(() => pollenModule.pollenRepository(gh<_i35.PollenRepositoryImpl>()));
    gh.factory<_i40.CurrentMoodBloc>(() => _i40.CurrentMoodBloc(
          moodRecordSubject: gh<_i34.MoodRecordSubject>(),
          currentMoodRepository: gh<_i38.MoodRecordRepository>(),
        ));
    gh.factory<_i41.CurrentPollenBloc>(() => _i41.CurrentPollenBloc(
          pollenRecordSubject: gh<_i36.PollenSubject>(),
          currentPollenRepository: gh<_i39.PollenRepository>(),
        ));
    return this;
  }
}
...
class _$ConfigModule extends _i42.ConfigModule {}

class _$ProfileModule extends _i42.ProfileModule {}

class _$MoodModule extends _i42.MoodModule {}

class _$PollenModule extends _i42.PollenModule {}
