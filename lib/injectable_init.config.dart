...
import 'data/mappers/profile/profile_model_to_profile_entity_mapper.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.MoodRecordRepositoryIsarImpl>(() => moodModule.moodRepositoryImpl(
          gh<_i10.MoodLocalStorageDatasourceIsar>(),
          gh<_i12.MoodRecordModelIsarToEntityMapper>(),
          gh<_i11.MoodRecordEntityToModelIsarMapper>(),
        ));
    gh.factory<_i14.MoodRecordSubject>(() => moodModule.moodRepository(gh<_i13.MoodRecordRepositoryIsarImpl>()));
    ...
    gh.factory<_i24.MoodRecordRepository>(() => moodModule.moodSubject(gh<_i13.MoodRecordRepositoryIsarImpl>()));
    gh.factory<_i25.PollenDtoToPollenEntityMappper>(
        () => _i25.PollenDtoToPollenEntityMappper(stringSpeciesMapper: gh<_i21.StringSpeciesMapper>()));
    gh.factory<_i26.PollenRepository>(
      () => _i27.PollenRepositoryImpl(
        dio: gh<_i8.Dio>(),
        pollenDtoToPollenEntityMapper: gh<_i25.PollenDtoToPollenEntityMappper>(),
      ),
      registerFor: {
        _test,
        _prod,
    ...
    gh.factory<_i26.PollenRepository>(
      () => _i28.PollenRepositoryMock(mapper: gh<_i25.PollenDtoToPollenEntityMappper>()),
      registerFor: {_dev},
    );
    gh.factory<_i29.ProfileModelIsarToEntityMapper>(
        () => _i29.ProfileModelIsarToEntityMapper(stringSpeciesMapper: gh<_i21.StringSpeciesMapper>()));
